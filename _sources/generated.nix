...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  claude-code-ide = {
    ...
    version = "95e3fe93babd4af9faf02709bf9fdca25fc361f1";
    src = fetchFromGitHub {
      owner = "manzaltu";
      repo = "claude-code-ide.el";
      rev = "95e3fe93babd4af9faf02709bf9fdca25fc361f1";
      fetchSubmodules = false;
      sha256 = "sha256-1jJCRiXa9dKM5yKW/ZOvEcp/MznM5zvC40sPIGYfQqY=";
    };
    date = "2025-07-22";
  };
  gcal = {
  ...
  vivaldi-darwin = {
    ...
    version = "7.5.3735.54";
    src = fetchurl {
      url = "https://downloads.vivaldi.com/stable/Vivaldi.7.5.3735.54.universal.dmg";
      sha256 = "sha256-49gdZOp+X5lVGGygavPQt4TNyXMf4ndQce91nNjZ/0Q=";
    };
  };
}
