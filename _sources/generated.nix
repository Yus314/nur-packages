...
}:
{
  ...
  cskk = {
    pname = "cskk";
    version = "c55dc4790394d95df1229ab5a1c537ce025eb2ff";
    src = fetchFromGitHub {
      owner = "naokiri";
      repo = "cskk";
      rev = "c55dc4790394d95df1229ab5a1c537ce025eb2ff";
      fetchSubmodules = false;
      sha256 = "sha256-F4sqyqD8Qdc/mhPpINCFjzuWiBOKSat5YIT1WnoEHck=";
    };
    date = "2026-03-28";
  };
  fcitx5-cskk = {
  ...
  vivaldi-darwin = {
    ...
    version = "8.0.4033.44";
    src = fetchurl {
      url = "https://downloads.vivaldi.com/stable/Vivaldi.8.0.4033.44.universal.dmg";
      sha256 = "sha256-/DEeoW2l9wNTC01KaTb6gxt/sym6eaLpJBWW4rOr6F8=";
    };
  };
}
