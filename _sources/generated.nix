...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  kakoune-themes = {
    ...
    version = "ddb63a8ce041622edaf37e2cf10378a656065c85";
    src = fetchFromGitHub {
      owner = "Yus314";
      repo = "kakoune-themes";
      rev = "ddb63a8ce041622edaf37e2cf10378a656065c85";
      fetchSubmodules = false;
  ...
  sprout = {
    pname = "sprout";
    version = "89f5245412d2d991176e81151f79cb01203ad6df";
    src = fetchFromGitHub {
      owner = "Yus314";
      repo = "sprout";
      rev = "89f5245412d2d991176e81151f79cb01203ad6df";
      fetchSubmodules = false;
      sha256 = "sha256-YvaGPdntH3fLUkfeu1kQpBi75sCV7T6GAm8M4hM9uCY=";
    };
    date = "2026-02-27";
  };
  typst-preview = {
