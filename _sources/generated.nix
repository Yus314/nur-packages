...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  claude-code-ide = {
    ...
    version = "d22f7a1cf995b1c2e91094c069de03037e7e9a0e";
    src = fetchFromGitHub {
      owner = "manzaltu";
      repo = "claude-code-ide.el";
      rev = "d22f7a1cf995b1c2e91094c069de03037e7e9a0e";
      fetchSubmodules = false;
      sha256 = "sha256-Bs+S6qbJaW8NIAXSG/qZN9SYXgCODni2ApQGo1U3PXA=";
    };
    date = "2025-09-11";
  };
  cskk = {
  ...
  fcitx5-cskk = {
    pname = "fcitx5-cskk";
    version = "4a1bafd969d67ae1a217b90b2fdd81787c5a1294";
    src = fetchFromGitHub {
      owner = "fcitx";
      repo = "fcitx5-cskk";
      rev = "4a1bafd969d67ae1a217b90b2fdd81787c5a1294";
      fetchSubmodules = false;
      sha256 = "sha256-Kn+Lxa18hcyfSBdONLj1eSXN+MxnU6aTz89F/9QeEK8=";
    };
    date = "2025-09-11";
  };
  gcal = {
  ...
  vivaldi-darwin = {
    ...
    version = "7.5.3735.74";
    src = fetchurl {
      url = "https://downloads.vivaldi.com/stable/Vivaldi.7.5.3735.74.universal.dmg";
      sha256 = "sha256-ohJo5EdbqMg1YO+heR6IB/vqT+yAmCDlqYdPxBtT2tE=";
    };
  };
}
