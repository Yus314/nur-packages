...
}:
{
  ...
  cskk = {
    pname = "cskk";
    version = "1cd2559617fa91ec9dfcbf2a47089433cd1f8a02";
    src = fetchFromGitHub {
      owner = "naokiri";
      repo = "cskk";
      rev = "1cd2559617fa91ec9dfcbf2a47089433cd1f8a02";
      fetchSubmodules = false;
      sha256 = "sha256-Ua/jmqW9FWmxbYQF1DcFbMIv57BDpEDu1Lv1PS7t43s=";
    };
    date = "2026-03-15";
  };
  fcitx5-cskk = {
  ...
  vivaldi-darwin = {
    ...
    version = "7.9.3970.39";
    src = fetchurl {
      url = "https://downloads.vivaldi.com/stable/Vivaldi.7.9.3970.39.universal.dmg";
      sha256 = "sha256-sS5Y1o0K/K92WLghn1XeVHA9N6ASoV0YMhhGRpGlLKE=";
    };
  };
}
